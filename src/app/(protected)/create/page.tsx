          ...
          <div className="mx-4 max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl dark:bg-slate-800">
            ...
            <div className="space-y-4 text-sm text-slate-700 dark:text-slate-300">
              <p>
                ...
                <strong>read-only access</strong> to the repository you want to
                analyze.
              </p>
                ...
                <ol className="space-y-2 pl-4">
                  ...
                  <li>
                    ...
                    <ul className="mt-1 ml-4 list-disc space-y-1">
                      ...
                      <li>
                        <strong>Resource owner</strong>: Your GitHub username or
                        organization
                      </li>
                    </ul>
                  </li>
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>We do not store your token</strong> — it is used only
                  for this session.
                </p>
              </div>
            </div>
